...
import in.omerjerk.boomerrang.gles.FullFrameRect;
import in.omerjerk.boomerrang.gles.Texture2dProgram;
...
public class MainActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File outputFile = new File(Environment.getExternalStorageDirectory(), "boomerrang.mp4");
...
class CameraSurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    public CameraSurfaceRenderer(MainActivity.CameraHandler cameraHandler,
                                 TextureMovieEncoder movieEncoder, File outputFile, File filesDir) {
            ...
            switch (mRecordingStatus) {
                case RECORDING_OFF:
                    ...
                    mVideoEncoder.startRecording(new TextureMovieEncoder.EncoderConfig(
                            mOutputFile, mIncomingHeight, mIncomingWidth, 1000000, EGL14.eglGetCurrentContext()));
